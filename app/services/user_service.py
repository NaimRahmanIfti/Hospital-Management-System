...
class UserService(BaseService):
    ...
    Encapsulates all user operations.
    """
    ...
    def create(self, data: UserCreate) -> User:
        ...
        # Step 4: save to DB
        self._db.add(user)       # stage the INSERT
        self.commit()        # write to PostgreSQL
        self.refresh(user)   # re-read from DB → populates user.id, defaults, etc.
